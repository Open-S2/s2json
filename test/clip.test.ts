...
import { clipLine, clipPoint, splitTile } from '../src/clip';
import { describe, expect, it, test } from 'bun:test';

import type { BBox, VectorFeature, VectorLineString, VectorPointGeometry } from '../src';
  ...
  expect(res2).toEqual([
    {
      line: [
        ...
        { m: { a: 2 }, x: 7, y: 10, z: -2 },
        { m: { a: 3 }, x: 7.2, y: 10.5, z: 0.5, t: 1 },
        { m: undefined, x: 7.5, y: 10.5, z: 3, t: 1 },
        { m: { a: 3 }, x: 4.833333333333333, y: 2.5, z: 3, t: 1 },
        { m: { a: 1 }, x: 4.5, y: 2.5, z: 4, t: 1 },
      ],
      offset: 2.5495097567963922,
